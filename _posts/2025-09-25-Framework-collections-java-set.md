...
Pour conclure, ce qu'il faut retenir c'est que les ensembles (Set) garantissent l’unicité des éléments, qu'il ne pas oublier d'implémenter `equals`/`hashCode`.
